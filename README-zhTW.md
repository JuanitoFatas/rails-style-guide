...
* [開發 Rails 應用程式](#開發-rails-應用程式)
    * [設定檔 (Config)](#設定檔-config)
    * [路由 (Routes)](#路由-routes)
    * [控制器 (Controller)](#控制器-controller)
    * [資料模型 (Model)](#資料模型-model)
    * [遷移 (Migrations)](#遷移-migrations)
    * [視圖 (Views)](#視圖-views)
    * [國際化 (I18n)](#國際化-i18n)
    * [資產 (Assets)](#資產-assets)
    * [郵件 (Mailers)](#郵件-mailers)
    * [打包 (Bundler)](#打包-bundler)
    * [貴重的 Gems](#貴重的-gems)
    * [缺陷的 Gems](#有缺陷的-gems)
    * [管理處理程序 (Process)](#管理處理程序-process)
* [測試 Rails 應用程式](#測試-rails-應用程式)
    * [Cucumber](#cucumber)
    * [RSpec](#rspec)
